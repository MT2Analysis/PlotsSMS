...
if model == "T1tttt":
    ...
    f0 = ROOT.TFile("config/limits_2017_Mar07/limits_T1qqqq_full_Mar07_V2.root")
elif model == "T2tt":
    ...
    f0 = ROOT.TFile("config/limits_2017_Mar07/limits_T2qq_full_Mar07_V1.root")
    f0b = ROOT.TFile("config/limits_2017_Mar07/limits_T2qq_full_Mar07_V1-OneFold.root")

#if model == "T1tttt":
#    f1 = ROOT.TFile("limits_T1tttt_FullRunII_17MCfor18_ttbbWeights_v2.root")
#else:
f1 = ROOT.TFile("config/FullRunII_17MCfor18/"+model+"_results.root")
if model == "T2qq":
    f1b = ROOT.TFile("config/FullRunII_17MCfor18/"+model+"_results_OneFold.root")
...
#
t2qq1 = ROOT.TLatex(800, 450, "one light #tilde{q}")
t2qq1.SetTextColor(1)
t2qq1.SetTextAlign(11)
t2qq1.SetTextSize(0.035)
#
t2qq8 = ROOT.TLatex(1100, 800, "#tilde{q}_{L}+#tilde{q}_{R} (#tilde{u}, #tilde{d}, #tilde{s}, #tilde{c})")
t2qq8.SetTextColor(1)
t2qq8.SetTextAlign(11)
t2qq8.SetTextSize(0.035)
#
...
leg.SetLineColor(0)
leg.SetFillColor(0)
leg.AddEntry(gbase[1], "Moriond '17 ( 35.9 fb^{1} ) - Observed (95% CL)", "L")
leg.AddEntry(gbase[0], "Moriond '17 ( 35.9 fb^{1} ) - Expected (95% CL)", "L")
leg.AddEntry(gcomp[1], "Full Run II (2016-2018) ( 137.4 fb^{-1} ) - Observed (95% CL)", "L")
leg.AddEntry(gcomp[0], "Full Run II (2016-2018) ( 137.4 fb^{-1} ) - Expected (95% CL)", "L")
...
can.SaveAs(model+"_comparisonFullRunII_expOnly.png")
can.SaveAs(model+"_comparisonFullRunII_expOnly.pdf")
